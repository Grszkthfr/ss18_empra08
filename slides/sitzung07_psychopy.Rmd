...
#### Builder
-   point&click
-   Tutorilas und Material gibt es [hier](http://www.psychopy.org/resources/resources.html#materials-for-builder)
...
```
-   Nichts, denn Zeilen, die mit # **beginnen** werden bei der Ausführung ignoriert
...
--
    -   für *visual* findet man beispielsweise die beiden folgeden Funktionen [*Window*](http://psychopy.org/api/visual/window.html#psychopy.visual.Window) und [*TextStim*](http://psychopy.org/api/visual/imagestim.html#psychopy.visual.ImageStim)
