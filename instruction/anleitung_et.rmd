...
-   Befehlt "psypy mGCP-III-et.py" eingeben  
<img src="img/02_runbash.png">  
    -   Tipp: mit dem *Tabulator* könnt ihr automatisch das geschriebene Vervollstädnigen: mG + *Tab* wird dann zu "mGCP-III-et."
...
-   *block* sollte unverändert bleiben (siehe [Experiment neustarten](#experimentneustart))
...
-   Zuerst das Kamerabild auf den Bildschirm in der Kabine übertragen mit
    -   **a)** *Enter* auf der Experiment-Tastatur, oder der Tastatur in der Kabine
    -   **b)** Über den Button *Image -> Display PC* auf dem Eyetracker-PC
...
-   mit *beliebiger* Taste auf der rechten Tastatur die Kalibrierung starten  
    <img src="img/93et.png" width="750">  
-   Am Eyetracker-PC in Eyelink auf *Calibrate* klicken oder *c* auf der Experiment-Tastatur
...
-   Zur Validierung auf *Validate* klicken oder *v* auf der Experiment-Tastatur
    -   Mit *autotrigger* oder *Enter* die Kalibrierung starten
        -   wenn *autotrigger* nicht startete, dann FOLGT
    -   RIGHT ERROR: unter 1 und *GOOD*?
        -   Ja: Auf Output/Record klicken
        -   Nein: erneut validieren, ggf. erneut kalibrieren
...
### Signal
-   BESCHREIBUNG FOLGT
-   während den ersten beiden Spalten (VP sieht Fixationskreuz) sollten die beiden Linien parallel sein
