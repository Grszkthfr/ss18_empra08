...
-   Zum Ordner PFAD UND DATEINAME FOLGT mit dem Experiment navigieren
...
-   Blanko Display erscheint auf dem Bildschirm in der Kabine
...
-   Zuerst das Kamerabild auf den Bildschirm in der Kabine übertragen mit
    ...
    -   **b)** Über den Button FOLGT auf dem rechten PC
...
-   Instruktion erscheint auf dem Bildschirm in der Kabine  
...
### Kalibration zwischen den Blöcken
